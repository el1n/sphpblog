...
if($ok){
	...
	if(strpos($_POST['y'],array('/','.','\\','%','#',';')) === false && strlen($_POST['y']) == 2 && strpos($_POST['m'],array('/','.','\\','%','#',';')) === false && strlen($_POST['m']) == 2 && strpos($_POST['entry'],array('/','.','\\','%','#',';')) === false && strlen($_POST['entry']) == 18){
...
if($ok){
	...
	$result = write_comment($_POST['y'],$_POST['m'],$_POST['entry'],$comment_name,$comment_email,$comment_url,$comment_text,getIP(),$moderationFlag,time());
