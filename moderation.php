...
function page_content()
{
	...
	echo($theme_vars['max_image_width']);?>px;" id="text" name="banned_address_list" rows="20" cols="50" autocomplete="OFF"><?php echo($blog_config->getTag('BANNED_ADDRESS_LIST'));?></textarea><br /><br />

				<?php echo(_sb('banned_word_list_title'));?>
			<label for="info_keywords"><?php echo(_sb('banned_word_list'));?></label><br />
				<textarea style="width: <?php global $theme_vars;
	echo($theme_vars['max_image_width']);?>px;" id="text" name="banned_word_list" rows="20" cols="50" autocomplete="OFF"><?php echo($blog_config->getTag('BANNED_WORD_LIST'));?></textarea><br /><br />
