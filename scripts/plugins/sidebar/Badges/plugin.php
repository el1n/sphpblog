	...
	function optionsForm()
	{
		...
		ob_start();?>
			...
			<p>Powered By</p>
				...
				<input type="checkbox" name="sphpblog" <?php if(!empty($sphpblog)){
			echo $checked;
		}?>>
                                <label for="sphpblog">Simple PHP Blog</label><br />
				<input type="checkbox" name="php" <?php if(!empty($php)){
			echo $checked;
		}?>>
                                <label for="php">PHP</label><br />
				<input type="checkbox" name="text" <?php if(!empty($text)){
			echo $checked;
		}?>>
                                <label for="text">Text</label><br />
				<input type="checkbox" name="rss" <?php if(!empty($rss)){
			echo $checked;
		}?>>
                                <label for="rss">RSS</label><br />
				<input type="checkbox" name="atom" <?php if(!empty($atom)){
			echo $checked;
		}?>>
                                <label for="atom">ATOM</label><br />
				<input type="checkbox" name="rdf" <?php if(!empty($rdf)){
			echo $checked;
		}?>>
