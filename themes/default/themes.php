...
function theme_default_colors()
{
	global $lang_string;
	$color_def = array();
	array_push($color_def,array('id'=>'bg_color','string'=>$lang_string['bg_color'],'default'=>'CCCC99'));
	array_push($color_def,array('id'=>'border_color','string'=>$lang_string['border_color'],'default'=>'4D4D45'));
	array_push($color_def,array('id'=>'main_bg_color','string'=>$lang_string['main_bg_color'],'default'=>'FFFFFF'));
	array_push($color_def,array('id'=>'menu_bg_color','string'=>$lang_string['menu_bg_color'],'default'=>'F2F2F2'));
...
function theme_menu_block($blockArray,$comment = 'MENU BLOCK',$toggleDiv = null)
{
	...
	/*
	  <!-- LINKS -->
	  <a id="linkSidebarLinks" onclick="toggleBlock('SidebarLinks');"><img width="11" height="11" src="themes/default/images/minus.gif" alt="twisty"> <span class="menu_title">Links</span></a><br />
	...
	*/
	...
	if(isset($blockArray['content']) && $blockArray['content'] != ''){
		...
		if(isset($toggleDiv)){
			echo('<a id="link'.$toggleDiv.'" onclick="toggleBlock(\''.$toggleDiv.'\');"><img width="11" height="11" src="'.$img_hide.'" alt="twisty" /> ');
		}
