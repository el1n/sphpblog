...
function theme_genericentry($entry_array,$style = 'normal')
{
...
function theme_default_colors()
{
	...
	// Backgrounds
	array_push($color_def,array('id'=>'bg_color','string'=>$lang_string['bg_color'],'default'=>'D9D9D2'));
	array_push($color_def,array('id'=>'header_bg_color','string'=>$lang_string['header_bg_color'],'default'=>'8C8C7E'));
	array_push($color_def,array('id'=>'footer_bg_color','string'=>$lang_string['footer_bg_color'],'default'=>'8C8C7E'));
	array_push($color_def,array('id'=>'main_bg_color','string'=>$lang_string['main_bg_color'],'default'=>'D7D7CF'));
	array_push($color_def,array('id'=>'menu_bg_color','string'=>$lang_string['menu_bg_color'],'default'=>'59594F'));

	// Borders
	array_push($color_def,array('id'=>'border_color','string'=>$lang_string['border_color'],'default'=>'58584E'));
	array_push($color_def,array('id'=>'inner_border_color','string'=>$lang_string['inner_border_color'],'default'=>'9A9A8C'));

	// Text Colors
	array_push($color_def,array('id'=>'header_txt_color','string'=>$lang_string['header_txt_color'],'default'=>'FFFFFF'));
	array_push($color_def,array('id'=>'footer_txt_color','string'=>$lang_string['footer_txt_color'],'default'=>'FFFFFF'));
	array_push($color_def,array('id'=>'txt_color','string'=>$lang_string['txt_color'],'default'=>'737367'));
	array_push($color_def,array('id'=>'headline_txt_color','string'=>$lang_string['headline_txt_color'],'default'=>'737367'));
	array_push($color_def,array('id'=>'date_txt_color','string'=>$lang_string['date_txt_color'],'default'=>'A6A695'));

	// Regular Entries
	array_push($color_def,array('id'=>'entry_bg','string'=>$lang_string['entry_bg'],'default'=>'F2F2EB'));
	array_push($color_def,array('id'=>'entry_title_bg','string'=>$lang_string['entry_title_bg'],'default'=>'BEBEB5'));
	array_push($color_def,array('id'=>'entry_border','string'=>$lang_string['entry_border'],'default'=>'95958C'));
	array_push($color_def,array('id'=>'entry_title_text','string'=>$lang_string['entry_title_text'],'default'=>'666661'));
	array_push($color_def,array('id'=>'entry_text','string'=>$lang_string['entry_text'],'default'=>'4F4F48'));

	// Static Entries
	array_push($color_def,array('id'=>'static_bg','string'=>$lang_string['static_bg'],'default'=>'F2F2EB'));
	array_push($color_def,array('id'=>'static_title_bg','string'=>$lang_string['static_title_bg'],'default'=>'BEBEB5'));
	array_push($color_def,array('id'=>'static_border','string'=>$lang_string['static_border'],'default'=>'95958C'));
	array_push($color_def,array('id'=>'static_title_text','string'=>$lang_string['static_title_text'],'default'=>'666661'));
	array_push($color_def,array('id'=>'static_text','string'=>$lang_string['static_text'],'default'=>'4F4F48'));

	// Comment Entries
	array_push($color_def,array('id'=>'comment_bg','string'=>$lang_string['comment_bg'],'default'=>'F2F2EB'));
	array_push($color_def,array('id'=>'comment_title_bg','string'=>$lang_string['comment_title_bg'],'default'=>'BEBEB5'));
	array_push($color_def,array('id'=>'comment_border','string'=>$lang_string['comment_border'],'default'=>'95958C'));
	array_push($color_def,array('id'=>'comment_title_text','string'=>$lang_string['comment_title_text'],'default'=>'666661'));
	array_push($color_def,array('id'=>'comment_text','string'=>$lang_string['comment_text'],'default'=>'4F4F48'));

	// Menu / Sidebar
	array_push($color_def,array('id'=>'menu_bg','string'=>$lang_string['menu_bg'],'default'=>'ACACA0'));
	array_push($color_def,array('id'=>'menu_title_bg','string'=>$lang_string['menu_title_bg'],'default'=>'959587'));
	array_push($color_def,array('id'=>'menu_border','string'=>$lang_string['menu_border'],'default'=>'DADACE'));
	array_push($color_def,array('id'=>'menu_title_text','string'=>$lang_string['menu_title_text'],'default'=>'FFFFFF'));
	array_push($color_def,array('id'=>'menu_text','string'=>$lang_string['menu_text'],'default'=>'FFFFFF'));

	// Links
	array_push($color_def,array('id'=>'link_reg_color','string'=>$lang_string['link_reg_color'],'default'=>'59594F'));
	array_push($color_def,array('id'=>'link_hi_color','string'=>$lang_string['link_hi_color'],'default'=>'FF6600'));
	array_push($color_def,array('id'=>'link_down_color','string'=>$lang_string['link_down_color'],'default'=>'6329F7'));
	array_push($color_def,array('id'=>'menu_link_reg_color','string'=>$lang_string['menu_link_reg_color'],'default'=>'59594F'));
	array_push($color_def,array('id'=>'menu_link_hi_color','string'=>$lang_string['menu_link_hi_color'],'default'=>'FF6600'));
	array_push($color_def,array('id'=>'menu_link_down_color','string'=>$lang_string['menu_link_down_color'],'default'=>'6329F7'));
	return($color_def);
}
